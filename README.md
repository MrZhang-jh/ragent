...
| 赞助伙伴 | 服务介绍与专属福利 |
|:---:|---|
| <a href="https://moacode.org/register?ref=doorbyte"><img src="assets/moacode.svg" alt="moacode" width="180" /></a> | moacode 是一家稳定、高效的 API 中转服务商，提供 Claude、GPT、Codex、Claude Code 等多种模型调用服务。Ragent AI 用户可[通过此链接](https://moacode.org/register?ref=doorbyte) 注册，并在充值时填写 `MAGE` 优惠码，享受 9 折优惠。 |
